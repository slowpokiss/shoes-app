          ...
          <div className="footer-container-item footer-info">
            <section>
              ...
              <ul className="nav flex-column">
                <Link to="/about" onClick={scrollTop} className="nav-item">
                  О магазине
                </Link>
                <Link to="/catalog" onClick={scrollTop} className="nav-item">
                  Каталог
                </Link>
                <Link to="/contacts" onClick={scrollTop} className="nav-item">
                  Контакты
                </Link>
              </ul>
            </section>
